    ...
    <div className='min-h-screen overflow-hidden'>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex ">
                ...
                <li className="pb-6  py-2 px-6 text-center  border-b-2 md:border-b-0 ">
                  <Link href="/pages/signin" onClick={() => setNavbar(!navbar)}>
      ...
      <section className='relative z-10'>
        <div className="flex flex-col justify-center items-center h-screen md:text-xl text-center">
          ...
          <Link href="/pages/signin"><button className="mt-3 border-2 border-[#2dabb1] p-2 hover:bg-[#2dabb1]  hover:text-white">
            Join Our Community
          </button></Link>
        </div>
      </section>
