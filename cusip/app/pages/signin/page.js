    ...
    return (
        <div className='min-h-screen overflow-y-scroll overflow-hidden flex justify-center items-center'>
            ...
            <div className='w-[80%] h-[80%] rounded p-5 bg-white border shadow flex justify-center items-center z-10'>
                <div className='w-full sm:w-1/2 pl-3 sm:pl-14 justify-center flex flex-col p-5 sm:p-10'>
                    ...
                    <button className='max-w-[300px] rounded mt-4 p-1 text-white bg-black'>SignIn</button>
                    <div className='mt-3'>
                ...
                <div className='w-1/2 hidden sm:block shadow rounded-md h-full'>
